...
<div class="info-box">
    ...
    <div>📊 Analyze and parse resumes (PDF, DOCX)</div>
    <div>🎯 Extract skills, experience, and qualifications</div>
    <div>⚡ Rank candidates based on job requirements</div>
    <div>📈 Reduce manual screening time by 80%</div>
    <div>🎯 Improve hiring accuracy with AI insights</div>
</div>
""", unsafe_allow_html=True)
